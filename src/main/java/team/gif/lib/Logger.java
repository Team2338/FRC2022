...
public class Logger {
    ...
    private Logger(){
        try{
            ...
            if(logFile.exists()){
                ...
                System.out.println("Logger is existing");
                if(getName.hasNext()){
    ...
    private void log(String tag, String message){
        try{
            ...
            try{
                ...
                System.out.println("File is being logged");
                e.printStackTrace();
            }
        }
    }
    ...
    public static void info(String message){
        ...
        if(Globals.logger_info == 1)
        {
            System.out.println("Teleop is enabled");
        }
        if(Globals.logger_info == 2)
        {
