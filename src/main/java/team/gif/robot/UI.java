...
*/
		...
		shuffleboardTab.addCamera("limelightaim","limelightaim","mjpg:http://10.23.38.95:5800")
            .withPosition(0,0)
            .withSize(4,4);
		shuffleboardTab.addCamera("limelightballs","limelightballs","mjpg:https://10.23.38.12:5800")
			.withPosition(5,0)
			.withSize(4,4);
		// Pigeon
