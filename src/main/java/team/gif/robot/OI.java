...
public class OI {
	...
	public final AxisButton dRTrigger = new AxisButton(driver, 3, 0.05);
	public final AxisButton dLTrigger = new AxisButton(driver, 2, 0.05);
	...
	public final AxisButton aRTrigger = new AxisButton(aux, 3, 0.05);
	public final AxisButton aLTrigger = new AxisButton(aux, 2, 0.05);
